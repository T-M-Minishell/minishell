...
typedef struct s_redir_cmds
{
	char				**arr;
	struct s_redir_cmds	*next;
}						t_redir_cmds;
...
void					mini_wc(t_list_token *data, int lines, int words,
							int chars);
...
void					handle_pipe(char *line, t_list_token *data,
							env_var **vars);
