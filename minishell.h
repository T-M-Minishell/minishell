...
void							ft_lstreset(t_list_token *data,
									t_token_type token);
...
void							ft_lstrest(t_list_token *data,
									t_token_type token);
...
void							handle_line(t_input *input, t_list_token *data,
									env_var **env_vars);
env_var							*handle_tokens_in_prompt(char **commands,
									env_var **env_vars);
...
env_var							*delete_env_var(env_var *old_env_vars,
									char *key);
...
env_var							*handle_pipe(t_list_token *data,
									env_var *env_vars);
...
int								execute_builtins_with_output(char **commands,
									env_var *vars);
env_var							*exec_env_var_fct(char **commands,
									env_var *vars);
bool							check_for_env_commands(char **commands);

// -----------------simple comands-----------
void							execute_process(char *path, char **argv,
									env_var *vars);
