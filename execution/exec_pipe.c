...
/*   Updated: 2024/07/10 21:30:09 by msacaliu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	child_process(t_list_commands *current, int (*pipes)[2], t_env_var *vars, int i)
{
	int		j;
	char	*path;
...
t_env_var	*parent_process(t_list_commands *current, int pid,int (*pipes)[2], t_env_var *vars)
{
	int status;
	int i;
